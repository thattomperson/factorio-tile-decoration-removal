...
data:extend{
  ...
  { name          = 'toms-extra-walls:run-time-in-seconds',
    type          = 'int-setting' ,
  ...
  { name          = 'toms-extra-walls:run-time-per-crank-in-seconds',
    type          = 'int-setting' ,
    setting_type  = 'startup'     ,
    default_value =  10           ,
    minimum_value =  1            ,
  ...
  { name          = 'toms-extra-walls:crank-delay-in-ticks',
    type          = 'int-setting' ,
    setting_type  = 'startup'     ,
    default_value =  20           ,
    minimum_value =  1            ,
  ...
  { name          = 'toms-extra-walls:power-output-in-watts',
    type          = 'int-setting' ,
    setting_type  = 'startup'     ,
    default_value =  20000        ,
    minimum_value =  1            ,
  ...
  { name          = 'toms-extra-walls:recipe-enabled',
    type          = 'bool-setting',
    setting_type  = 'startup'     ,
    default_value =  true         ,
    order         = 'g-a'         ,
